...
func (s *JarService) CreateJar() (string, error) {
	jarID, err := s.jarStore.Create()
...
func (s *JarService) NewRequest(jarID string, request *models.Request) {
	s.requestStore.Create(jarID, request)
